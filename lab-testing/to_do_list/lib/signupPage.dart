...
class _SignupPageState extends State<SignupPage> {
  ...
  Future<void> addUser2(
      String firstName, String lastName, String id, String password) {
  ...
  void onPressed() async {
    ...
    if (_validation) {
      addUser2(controllers[0].text, controllers[1].text, controllers[2].text,
          controllers[3].text);
    }
  }
                      ...
                      children: <Widget>[
                        ...
                        TextFormField(
                          decoration: InputDecoration(
                              labelText: "Password",
                              errorText:
                                  _checked[3] ? 'Input the Password!' : null,
                              border: OutlineInputBorder()),
                          keyboardType: TextInputType.text,
