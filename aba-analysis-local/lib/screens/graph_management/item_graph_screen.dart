...
class _ItemGraphScreenState extends State<ItemGraphScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    exportData = ExportData("선생님", widget.child.name, allSuccessRate: _allSuccessRate, programField: widget.subItemList[0].testItem.programField, subArea: widget.subItemList[0].testItem.subField);
  ...
  List<GraphDataLocal> getItemGraphDataLocal(String _noChange, List<SubItemAndDate> subItemList) {
    // 날짜, 하위목록 이름, 평균 성공률
    ...
    for (SubItemAndDate subItemAndDate in subItemList) {
      ...
      int nowCount = subItemAndDate.testItem.plus + subItemAndDate.testItem.minus + subItemAndDate.testItem.p;
